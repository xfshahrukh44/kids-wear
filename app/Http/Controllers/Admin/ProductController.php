...
//            }
            ...
            for($i = 0; $i < count(request()->get('attribute_id')); $i++)
            {
                $product_attributes = new ProductAttribute;
                $product_attributes->attribute_id = request()->get('attribute_id')[$i];
                $product_attributes->value = request()->get('value')[$i];
                $product_attributes->price = request()->get('v_price')[$i];
                $product_attributes->qty = request()->get('qty')[$i];
