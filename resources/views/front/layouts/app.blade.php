                    ...
                    <div class="col-lg-12">
                        <div class="main-header">
                            <nav class="navbar navbar-expand-lg navbar-light">
                                <a class="navbar-brand logo" href="{{route('home')}}"><img src="{{asset('images/logo.png')}}"
                                ...
                                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                    ...
                                    <form class="form-inline my-2 my-lg-0 header-btn-2" action="{{route('front.shop')}}">
                                        <input class="form-control mr-sm-2" type="search" placeholder="Search"
                                               aria-label="Search" value="{{request()->get('search')}}" name="search">
                                        <button class="btn" type="submit"><i class="fas fa-search"></i></button>
                                        @if(auth()->check())
                                            <a href="{{route('account')}}" class="btn"><i class="far fa-user"></i> Account</a>
                                        @else
                                            <a href="{{route('signin')}}" class="btn"><i class="far fa-user"></i> Account</a>
                                        @endif
                                        <a href="{{route('cart')}}" class="btn"><i class="fas fa-shopping-cart"></i> Cart</a>
                                    </form>
                                </div>
                            </nav>
                        </div>
