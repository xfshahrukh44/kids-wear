            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="lable-txt gap">
                        <textarea name="notes" placeholder="Comment" id="" cols="30" rows="10" required class="form-control"></textarea>
                    </div>
                </div>

                <div class="col-lg-12">
                    <div class="lable-anker">
                        <button type="submit" class="btn btn-primary mt-2" style="height: 60px;width: 120px;"> Send </button>
                    </div>
